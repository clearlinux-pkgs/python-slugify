...
Source0  : https://files.pythonhosted.org/packages/40/78/dc0c2931eb93db0339d958f7cbbcb6591031b3e5d2759c927bd603b98786/python-slugify-5.0.0.tar.gz
...
%prep
%setup -q -n python-slugify-5.0.0
cd %{_builddir}/python-slugify-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619818966
...
cp %{_builddir}/python-slugify-5.0.0/LICENSE %{buildroot}/usr/share/package-licenses/python-slugify/39348c15454a917e7a44ef76017b198dc3834d8d
