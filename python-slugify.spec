...
Source0  : https://files.pythonhosted.org/packages/03/cd/f0b39ad9b5a17f93c0a006dbd49f67fc5dc8b53de58a61542bc034ca70a8/python-slugify-3.0.6.tar.gz
...
%prep
%setup -q -n python-slugify-3.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570906537
